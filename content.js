...
(function () {
    ...
    const frenchKeywords = new Set([
        // Kleidung
        "pantalon", "pantalons", "leggings", "blouse", "blouses", "tunique", "tuniques",
        "gilet", "gilets", "sweat", "sweats", "cardigan", "cardigans",
        "robe", "robes", "combinaison", "combinaisons", "jupe", "jupes",
        "blouson", "blousons", "anoraks",
        "sandales", "ballerines", "mocassins",
        "écharpe", "écharpes", "foulard", "foulards", "sac", "sacs",
        "chapeau", "chapeaux", "ceinture", "ceintures",
        "manteau", "manteaus",
        "bottes", "debardeur", "chemise", "chemises", "manche", "manches", "chemisier"
    

        // Materialien & Muster
        "coton", "laine", "soie", "lin", "cuir",
        "rayures", "pois", "carreaux", "fleurs", "velours", "jean"
        ...
        // Zustand & Stil
        "neuf", "neufs", "usagé", "usagée", "bon état",
        "vintage", "chic", "décontracté", "élégant", "élégante",
    ...
    "Petit Bateau", "Lacoste", "Chanel", "Dior", "Louis Vuitton", "Yves Saint Laurent", "Balmain", "Givenchy",
    "Jean Paul Gaultier", "Hermès", "Celine", "Lanvin", "Kenzo", "A.P.C.", "Isabel Marant", "Sandro", "Maje",
    "Ba&sh", "The Kooples", "Sézane", "Zadig & Voltaire", "Chloé", "Courrèges", "Jacquemus", "Patou", "Carven",
    "Officine Générale", "Pierre Cardin", "Paco Rabanne", "Loewe", "Kookaï", "Morgane", "Eden Park", "Agnes B",
    "Saint James", "Sessùn", "Le Coq Sportif", "Armor Lux", "IKKS", "Cop Copine", "Promod", "Gerard Darel",
    "Marithé + François Girbaud", "Naf Naf", "Cyrillus", "Vertbaudet", "Orcival", "American Vintage",
    "Maison Kitsuné", "Rouje", "Repetto", "Valentino",
]);
